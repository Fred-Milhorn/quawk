...
1. `T-142` add the evaluated-divergence metadata and companion compatibility notes
2. `T-143` add the optional CI job and promotion criteria for the upstream compatibility gate
