...
1. `T-141` reclassify the repo-owned corpus as supplemental `compat_local` coverage
2. `T-142` add the evaluated-divergence metadata and companion compatibility notes
3. `T-143` add the optional CI job and promotion criteria for the upstream compatibility gate
