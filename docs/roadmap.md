...
1. `T-148` add selected shell-driver adapters only for still-uncovered in-scope families
2. `T-149` complete the upstream-suite done-line audit and stop criteria
