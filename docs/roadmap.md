...
Target outcome:
- the remaining POSIX work is the final contract and done-line audit, not a
  manifest re-audit

1. `T-167` complete the POSIX done-line audit
2. `T-132` define the benchmark harness interface, workload suite, and measurement contract
