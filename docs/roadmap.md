...
1. `T-129` add differential corpus coverage for CLI/runtime option interactions and builtin variables
2. `T-130` add differential corpus coverage for coercions, regex/range boundaries, and builtin boundary behavior
3. `T-131` rebaseline the compatibility coverage matrix after the expansion wave
