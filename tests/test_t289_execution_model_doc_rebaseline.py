...
def test_t289_roadmap_marks_p33_complete_and_clears_t289_from_immediate_tasks() -> None:
    ...
    assert "| T-289 | P33 | P1 | Rebaseline the execution-model docs after direct-path collapse | T-288 | `docs/design.md`, the roadmap, and any direct-path inventory notes agree that the reusable backend path is the only compiled execution route and no stale direct-lane wording remains | done |" in roadmap_text
