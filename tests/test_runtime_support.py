    ...
    harness_path.write_text(
        "\n".join(
            [
                ...
                "    qk_slot_set_number_inline(runtime, 3, 42.5);",
                "    (void)qk_slot_get_number_inline(runtime, 3);",
                '    qk_slot_set_string_inline(runtime, 5, "slot-value");',
                "    (void)qk_slot_get_string_inline(runtime, 5);",
    ...
    harness_path.write_text(
        "\n".join(
            [
                ...
                "        return 1;",
                "    }",
                "    if (qk_slot_get_number_inline(runtime, 10) != 0.0) {",
                "        qk_runtime_destroy(runtime);",
                "        return 2;",
                "    }",
                "    qk_slot_set_number_inline(runtime, 10, 12.25);",
                "    if (fabs(qk_slot_get_number_inline(runtime, 10) - 12.25) > 1e-12) {",
                "        qk_runtime_destroy(runtime);",
                "        return 3;",
                "    }",
                '    if (strcmp(qk_slot_get_string_inline(runtime, 7), "") != 0) {',
                "        qk_runtime_destroy(runtime);",
                "        return 4;",
                "    }",
                '    qk_slot_set_string_inline(runtime, 7, "hello-slot");',
                '    if (strcmp(qk_slot_get_string_inline(runtime, 7), "hello-slot") != 0) {',
                "        qk_runtime_destroy(runtime);",
                "        return 5;",
                "    }",
                "    qk_runtime_destroy(runtime);",
...
def test_runtime_hot_path_inline_wrappers_round_trip(tmp_path: Path) -> None:
    harness_path = tmp_path / "runtime_hot_path_harness.c"
    executable_path = tmp_path / "runtime_hot_path_harness"
    harness_path.write_text(
        "\n".join(
            [
                '#include "qk_runtime.h"',
                ...
                "        return 1;",
                "    }",
                "    if (qk_next_record_inline(runtime)) {",
                "        qk_runtime_destroy(runtime);",
                "        return 2;",
                "    }",
                '    if (strcmp(qk_get_field_inline(runtime, 0), "") != 0) {',
                "        qk_runtime_destroy(runtime);",
                "        return 3;",
                "    }",
                '    if (strcmp(qk_capture_string_arg_inline(runtime, "fast"), "fast") != 0) {',
                "        qk_runtime_destroy(runtime);",
                "        return 4;",
                "    }",
                '    if (strcmp(qk_scalar_get_inline(runtime, "FS"), " ") != 0) {',
                "        qk_runtime_destroy(runtime);",
                "        return 5;",
                "    }",
                "    qk_scalar_set_number_inline(runtime, \"x\", 9.5);",
                "    if (fabs(qk_scalar_get_number_inline(runtime, \"x\") - 9.5) > 1e-12) {",
                "        qk_runtime_destroy(runtime);",
                "        return 6;",
                "    }",
                "    if (qk_get_nr_inline(runtime) != 0.0) {",
                "        qk_runtime_destroy(runtime);",
                "        return 7;",
                "    }",
                "    if (qk_get_fnr_inline(runtime) != 0.0) {",
                "        qk_runtime_destroy(runtime);",
                "        return 8;",
                "    }",
                "    if (qk_get_nf_inline(runtime) != 0.0) {",
                "        qk_runtime_destroy(runtime);",
                "        return 9;",
                "    }",
